...
rametcount <- read_csv(paste(datpath,"/Greenhouse_adult_ramet_counts.csv", sep="")) #adult ramet counts
...
germination <- read_csv(paste(datpath, "/Greenhouse_germination_dates.csv", sep = ""))
